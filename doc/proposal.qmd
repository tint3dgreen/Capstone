...
# Dataset
  ...
  * Owner Costs: Count of ownsership costs that fall into a certain range (USD). $500 bin size
...
4. Is Owning or Renting more affordable in Seattle? This will follow a similar process to Question 1 however the cutoff for affordable will be below 25% instead of 35%. Chase Bank reccomends mortgage payments should be no more than 28% of your income, so I will say 25% and below is 'affordable'. 
